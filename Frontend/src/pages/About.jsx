        ...
        <>
            ...
            <section className="h-full flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:w-1/2 h-min px-10 my-10 space-y-8 text-center lg:text-justify">
                    ...
                    <div className="space-y-3 border p-6 rounded-lg shadow-lg bg-blue-japan text-white">
                        <h2 className="font-nuku text-4xl text-center text-white">La Nostra Storia</h2>
                        <p>
                    ...
                    <div className="space-y-3 border p-6 rounded-lg shadow-lg bg-blue-japan text-white">
                        <h3 className="font-nuku text-4xl text-center text-white">La Nostra Missione</h3>
                        <p>
                    ...
                    <div className="space-y-3 border p-6 rounded-lg shadow-lg bg-blue-japan text-white">
                        <h3 className="font-nuku text-4xl text-center text-white">Cosa Offriamo</h3>
                        <ul>
                    ...
                    <div className="space-y-3 border p-6 rounded-lg shadow-lg bg-blue-japan text-white">
                        <h3 className="font-nuku text-4xl text-center text-white">Unisciti a Noi</h3>
                        <p>
                    ...
                    <div className="space-y-3 border p-6 rounded-lg shadow-lg bg-blue-japan text-white">
                        <h3 className="font-nuku text-4xl text-center text-white">Contattaci</h3>
                        <p>
