...
import novita from "../data/novità.json";
...
export default function Funko() {
  ...
  const totalPages = Math.ceil(novita.length / ITEMS_PER_PAGE);
  ...
  const currentItems = novita.slice(
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-10 items-center justify-center my-10">
        <h1 className="text-center text-7xl font-bold font-nuku my-5 pt-4">Novita della Settimana</h1>
