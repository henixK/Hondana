...
public class t_utente {
	...
	private t_utente(Integer ID_UTENTE, String NOME, String COGNOME, String PAROLA_SEGERTA, String INDIRIZZO_SPEDIZIONE,
			Integer DATA_DI_NASCIA, String GENERE_PREFERITO, String E_MAIL) {
